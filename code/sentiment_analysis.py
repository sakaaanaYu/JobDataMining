...
if __name__ == '__main__':
    sentiment_dict_path = "..\\data\\task4\\sentiment_words_chinese.tsv" 
    degree_dict_path ="..\\data\\task4\\degree_dict.txt"
    stop_dict_path = "..\\data\\cutwords\\stopwords.txt"

    # 文件路径
    file_path = '..\\data\\attitude_zhihu_raw.xlsx'
    # 读取 Excel 文件
    try:
